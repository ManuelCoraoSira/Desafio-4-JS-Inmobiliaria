...
const habitaciones=document.getElementById("floatingPassword-1");
const min_metros=document.getElementById("floatingPassword-2");
const max_metros=document.getElementById("floatingPassword-3");
